...
const Home = () => {
    ...
    function handleChangeCategory(categoryId, menuTypeId) {
        ...
        let selectRecommended = dummyData.menu.find(a => a.name == "Popular")

        //Retrieve the recommended menu
        let selectPopular = dummyData.menu.find(a => a.name == "Recommended")
        ...
        setPopular(selectPopular?.list.filter(a => a.categories.includes(categoryId)))

        //set the menu based ob the categoryId
